...
@implementation Area
@synthesize areaId, author, name, date, pictures, inventories, description, submitToServer, locationLocked, typeOfArea, latitudeArray, longitudeArray, persisted, locationPoints;
